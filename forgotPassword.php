            ...
            <form class="form-inline" action="#" method="post">
                <div class="vstack gap-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="email" class="form-control" placeholder="Member ID" aria-label="Email" name="email" required>
                    </div>
                    <!-- Password -->
                    <div class="input-group mb-2">
                        <span class="input-group-text fa fa-key pt-2"></span>
                        <input type="password" class="form-control" placeholder="Username" aria-label="Password" name="password" required>
                    </div>
                    <!-- Register Button -->
